...
{{ include "desktop-vnc.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "desktop-vnc.selectorLabels" -}}
...
*/}}
{{- define "desktop-vnc.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "desktop-vnc.fullname" .) .Values.serviceAccount.name }}
{{- else }}
